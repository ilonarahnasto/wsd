Ongelmat (kysyt��n assareilta)

- CSS-tiedosto ei lataudu. N�kyy kyll� tiedostona mutta sis�lt� ei p�ivity.
- user/login ja user/logout ei toimi
- user/login formi ei näy
...
[/] Security restrictions, e.g. developers are only allowed to modify/add/etc. their own games, developer can only add
...
[] This score must be recorded to the player's scores and to the global high score list for
...
[] Overall documentation, demo, teamwork, and project management as seen from the history of your GitLab project
